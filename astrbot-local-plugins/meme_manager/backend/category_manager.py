...
class CategoryManager:
    ...
    def update_description(self, category: str, description: str) -> bool:
        ...
        try:
            ...
            if saved:
                update_category_metadata(category, {"description": description})
            return saved
        except Exception as e:
    ...
    def rename_category(self, old_name: str, new_name: str) -> bool:
        ...
        try:
            ...
            saved = save_json(self.descriptions, MEMES_DATA_PATH)
            if saved:
                rename_category_metadata(old_name, new_name)
            return saved
        except Exception as e:
    ...
    def delete_category(self, category: str) -> bool:
        ...
        try:
            ...
            delete_category_metadata(category)
            return True
        except Exception as e:
        ...
        try:
            ...
            for category in local_categories:
                if category not in self.descriptions:
                    ...
                    changed = True
                ensure_category_metadata(category, self.descriptions.get(category, ""))
